        ...
        <div className="container-fluid min-vh-100 bg-light">
            <div className="row">
                ...
                <div className='upper d-md-none fixed-top d-flex items-align-center justify-content-between p-2 ps-3 bg-primary mb-1'>
                    <h1 className='m-0 text-light'>Academic Statistics</h1>
                ...
                <div className="bottomer col-md-10 pt-2 ms-auto">
                    <h2 className="mb-3">Assignment Scores</h2>
                    <div className="bg-white rounded shadow-sm p-4 mb-4">
                        <h5 className="fw-semibold mb-3">All Grades</h5>
                        <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={data}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis dataKey="semester" label={{ value: "Semester", position: "insideBottom", offset: -5 }} />
                            <YAxis domain={[0, 100]} label={{ value: "Scores", angle: -90, position: "insideLeft" }} />
                            <Tooltip />
                            <Legend verticalAlign="top" align="right" />
                            <Line type="monotone" dataKey="tugas" stroke="#d1d1d1" strokeWidth={3} name="Assignments" />
                            <Line type="monotone" dataKey="uts" stroke="#007bff" strokeWidth={3} name="Midterm" />
                            <Line type="monotone" dataKey="uas" stroke="#28a745" strokeWidth={3} name="Final Exam" />
                        </LineChart>
                        </ResponsiveContainer>
                    </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <p className="text-uppercase text-secondary fw-semibold mb-2 small">Total Courses</p>
                        <h1 className="fw-bold text-dark display-6 mb-0">27</h1>
                        <p className="text-muted small mt-1">Total across all semesters</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <p className="text-uppercase text-secondary fw-semibold mb-2 small">Total Credits</p>
                        <h1 className="fw-bold text-dark display-6 mb-0">87<span className="text-muted fs-5"> / 144</span></h1>
                        <p className="text-muted small mt-1">Credits earned vs. maximum</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <p className="text-uppercase text-secondary fw-semibold mb-2 small">Average Score</p>
                        <h1 className="fw-bold text-dark display-6 mb-0">83.4</h1>
                        <p className="text-muted small mt-1">Combined score across all semesters</p>
                        </div>
                    </div>
                    </div>
