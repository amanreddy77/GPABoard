            ...
            <div className="content d-flex align-items-center vh-100 px-5">
                <div className='d-grid gap-3'>
                    <div className="heading text-dark">
                        <p>GP<span className="text-primary">A</span>board Student Portal</p>
                    </div>
                    <div className="text warp-text text-dark w-50">
                        <p>Enhance your academic performance with GPAboard — Smart analytics, predictions, and recommendations to help you achieve your best GPA!</p>
                    </div>
