    ...
    return (
        <div className={`col-md-2 sidebar position-fixed vh-100 bg-white shadow-sm p-3 d-flex flex-column ${isOpen ? 'active' : ''}`}>
            <div className='d-flex gap-3 align-items-center justify-content-center'>
                ...
                <h4 className="fw-bold m-0">GP<span className="text-primary">A</span>Board</h4>
            </div>
            ...
            <ul className="nav flex-column mb-4">
                ...
                <li className="nav-item">
                    <NavLink to="/cgpa" className="nav-link">CGPA</NavLink>
                </li>
                <li className="nav-item">
            ...
            <div className="mt-auto miniaccount">
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <span className="badge bg-warning text-dark">Portal</span>
                    </div>
                </div>
